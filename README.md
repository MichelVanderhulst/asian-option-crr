...
Python-based app that pedagogically explains the hedging of Asian options using the Cox-Ross-Rubinstein model

## Visit the web app

The app can be found here: https://asian-option-crr.herokuapp.com
